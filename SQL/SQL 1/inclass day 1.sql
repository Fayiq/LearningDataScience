...
value("PayCard",'2','300.45','8000.87','9000.56');
...
insert into Bank_Inventory
value("PayPoints",'4','200.89','7000.67','6700.56');
...
select Geo_location,length(Geo_location)
from Bank_Inventory
...
values('2020-12-21','2020-12-21 18:45:45','2020-12-21 18:45:45');

update Bank_Holidays
set Holiday = '2020-12-22', Start_time = '2020-12-22 00:00:01', End_time = '2020-12-22 23:59:59';

# Question 14:
# 14) Modify  the Start_time data with today’s date in the Bank_Holidays table 

ALTER TABLE Bank_holidays RENAME COLUMN Start_time TO Today_date;

# Question 15:
# 15) Update the End_time with current european time in the Bank_Holidays table. 

update Bank_holidays
set End_time = '2020-12-23 23:45:00';
