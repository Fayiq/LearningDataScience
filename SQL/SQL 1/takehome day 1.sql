...
set estimate_sale_price = estimate_sale_price + (15 * estimate_sale_price)/100
where quantity > 4;
...
(product,quantity,price,purchase_cost,estimate_sale_price)
...
where estimate_sale_price - purchase_cost < (5 * estimate_sale_price)/100;
